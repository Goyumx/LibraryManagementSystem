...
public class MemberDto {
    ...
    public MemberDto(String MemberId, String MemberName, String MemberPhoneNo, String MemberDob, String MemberAddress) {
    ...
    public String toString() {
        return "MemberDto{" + "MemberId=" + MemberId + ", MemberName=" + MemberName + ", MemberPhoneNo=" + MemberPhoneNo + ", MemberDob=" + MemberDob + ", MemberAddress=" + MemberAddress + '}';
    }
